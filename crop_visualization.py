...
# ---------------------------------
# 0. 기준 해상도 & 1080p에서 찍은 ROI 좌표
# ---------------------------------
REF_W, REF_H = 1920, 1080   # FHD 기준

# 파란 팀 맨 위 영웅 아이콘 영역 (네가 방금 찍은 값)
HERO_X0, HERO_Y0 = 565.00, 216.00
HERO_X1, HERO_Y1 = 628.00, 280.00

# 처치 / 도움 / 죽음 묶음 (같은 줄 기준)
KDA_X0, KDA_Y0 = 910.00, 216.00
KDA_X1, KDA_Y1 = 1075.00, 280.00

# 피해 / 치유 / 경감 묶음 (같은 줄 기준)
DMG_X0, DMG_Y0 = 1075.00, 216.00
DMG_X1, DMG_Y1 = 1386.00, 280.00

N_BLUE_ROWS = 5
N_RED_ROWS  = 5

# 빨간 팀 맨 위 영웅 아이콘 y0
# 2K에서의 세로 오프셋 비율을 그대로 써서 근사치 계산
# offset_n ≈ (660.69 - 230) / 1151 ≈ 0.374
# RED_HERO_Y0_1080 ≈ HERO_Y0 + 0.374 * 1080 ≈ 620 근처
RED_HERO_Y0 = 619.0
RED_HERO_Y1 = RED_HERO_Y0 + (HERO_Y1 - HERO_Y0)  # 높이는 파란팀과 동일
